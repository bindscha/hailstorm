...
object SmallChunk {
  ...
  val dataSize: Int = Config.HailstormConfig.BackendConfig.DataConfig.smallChunkLength

  val metaSize: Int = Config.HailstormConfig.BackendConfig.DataConfig.metaLength

  val size: Int = dataSize + metaSize

  def wrap(bytes: Array[Byte]): SmallChunk = new RichSmallChunk(bytes)

}

object SmallChunkMeta {

  val smallChunkSizeSize: Int = Config.HailstormConfig.BackendConfig.DataConfig.chunkSizeLength
  ...
  val smallChunkSizeOffset: Int = Config.HailstormConfig.BackendConfig.DataConfig.smallChunkLength
  val cmdOffset: Int = Config.HailstormConfig.BackendConfig.DataConfig.smallChunkLength + smallChunkSizeSize
  val fingerprintOffset: Int = Config.HailstormConfig.BackendConfig.DataConfig.smallChunkLength + smallChunkSizeSize + cmdSize
  val bagOffset: Int = Config.HailstormConfig.BackendConfig.DataConfig.smallChunkLength + smallChunkSizeSize + cmdSize + fingerprintSize
  val offsetOffset: Int = Config.HailstormConfig.BackendConfig.DataConfig.smallChunkLength + smallChunkSizeSize + cmdSize + fingerprintSize + bagSize

}

trait SmallChunkMeta extends Any {
  this: SmallChunk =>

  import SmallChunkMeta._

  def chunkSize(size: Int): Unit = {
    val buf = ByteBuffer.wrap(array, smallChunkSizeOffset, smallChunkSizeSize)
    buf.putInt(size)
  }
...
trait SmallChunk extends Any with SmallChunkMeta {
